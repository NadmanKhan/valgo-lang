...
public:
  ...
  enum {
    RuleProg = 0, RuleProc = 1, RuleFunc = 2, RuleProto = 3, RuleBlock = 4, 
    RuleStmt = 5, RuleExpr = 6, RuleAtom = 7, RuleCall = 8, RuleIfElse = 9, 
    RuleDecl = 10, RuleAssign = 11, RulePrint = 12, RuleReturn = 13
  };
